...
class WorkflowCompiler(Protocol):
    ...
    def workflow_name(self) -> str:
        """Return the workflow name identifier."""
        ...

    def get_workflow_dir(self, context: CompilerContext) -> Path:
        """Return the workflow directory containing templates and config."""
        ...

    def get_required_files(self) -> list[str]:
        """Return glob patterns for files required by this workflow."""
        ...
    ...
    def validate_context(self, context: CompilerContext) -> None:
        """Validate that the compiler context meets workflow requirements."""
        ...

    def compile(self, context: CompilerContext) -> CompiledWorkflow:
        """Compile the workflow into a CompiledWorkflow ready for LLM."""
        ...
