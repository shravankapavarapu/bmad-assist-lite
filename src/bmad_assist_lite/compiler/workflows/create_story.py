"""Compiler for create-story workflow."""

import importlib.resources
from pathlib import Path
from typing import Any

from bmad_assist_lite.compiler.context_filter import apply_context_filter, filter_epic_to_story
...
class CreateStoryCompiler:
    ...
    def get_workflow_dir(self, context: CompilerContext) -> Path:
        ...
        ref = importlib.resources.files("bmad_assist_lite.workflows") / "create-story"
        return Path(str(ref))
