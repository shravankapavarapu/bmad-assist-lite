"""Compiler for code-review-synthesis workflow."""

import importlib.resources
from pathlib import Path
from typing import Any

from bmad_assist_lite.compiler.context_filter import strip_synthesis_reports
...
class CodeReviewSynthesisCompiler:
    ...
    def get_workflow_dir(self, context: CompilerContext) -> Path:
        ...
        ref = importlib.resources.files("bmad_assist_lite.workflows") / "code-review-synthesis"
        return Path(str(ref))
    ...
    def compile(self, context: CompilerContext) -> CompiledWorkflow:
        """Compile code-review-synthesis workflow."""
